...
public class FrameGrab {
        ...
        mGLHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(width != -1){
                    ...
                    output.setWidth((int)codec.getWidth());
                    output.setHeight((int)codec.getHeight());
                }
    ...
    public long getFrameRate(){ return codec.getFPS(); }
    public long getDuration() { return codec.getDuration(); } // In Microseconds
}
